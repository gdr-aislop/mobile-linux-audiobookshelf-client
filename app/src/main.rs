...
mod tests {
    ...
    gtk_scenarios! {
        ...
        (player_screen_download_rows_show_size_estimates_that_track_the_stepper, crate::screens::player::tests::run_download_rows_show_size_estimates_that_track_the_stepper),

        (player_screen_download_rows_block_when_free_space_is_insufficient, crate::screens::player::tests::run_download_rows_block_when_free_space_is_insufficient),
